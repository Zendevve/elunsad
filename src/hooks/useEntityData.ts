  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Never show toasts automatically
      } finally {
        setIsLoading(false);
      }
    };
    ...
    try {
      ...
      if (result) {
        ...
        if (showToast === true) {
          ...
          console.log("Toast notification suppressed - showToast was:", showToast);
        }
      ...
      if (showToast === true) {
        ...
        console.log("Error toast notification suppressed - showToast was:", showToast);
      }
